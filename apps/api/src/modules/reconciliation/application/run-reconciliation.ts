      ...
      await prisma.$executeRawUnsafe(
        `
          ...
          ON DUPLICATE KEY UPDATE
            ...
            snapshot_thumb_key = VALUES(snapshot_thumb_key),
            updated_at = NOW()
        `,
        toId(spot.siteId),
        toId(spot.zoneId),
        ...
        decision.snapshotThumbKey ?? null,
      )
      ...
      const row = await prisma.$queryRawUnsafe<any[]>(
        `
          SELECT
            ...
            snapshot_thumb_key AS snapshotThumbKey,
      ...
      const rows = await prisma.$queryRawUnsafe<any[]>(
        `
          SELECT
            ...
            p.snapshot_thumb_key AS snapshotThumbKey,
      ...
      row.snapshotJson == null
        ...
        : typeof row.snapshotJson === 'string'
          ...
          : typeof row.snapshotJson === 'object'
            ? row.snapshotJson
            : {},
    snapshotThumbKey: row.snapshotThumbKey == null ? null : String(row.snapshotThumbKey),
