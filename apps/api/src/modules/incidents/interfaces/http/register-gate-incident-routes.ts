...
export function registerGateIncidentRoutes(api: Router) {
  api.get('/ops/incidents', requireAuth(ADMIN_OPS_GUARD_ROLES), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.get('/ops/incidents/:incidentId', requireAuth(ADMIN_OPS_GUARD_ROLES), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.post('/ops/incidents/:incidentId/resolve', requireAuth(ADMIN_OPS_GUARD_ROLES), async (req: Request, res: Response, next: NextFunction) => {
    try {
