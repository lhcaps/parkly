...
export function registerSubscriptionAdminRoutes(api: Router) {
  api.get('/admin/subscriptions', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.get('/admin/subscriptions/:subscriptionId', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.post('/admin/subscriptions', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.patch('/admin/subscriptions/:subscriptionId', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.get('/admin/subscription-spots', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.post('/admin/subscription-spots', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.patch('/admin/subscription-spots/:subscriptionSpotId', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.get('/admin/subscription-vehicles', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.post('/admin/subscription-vehicles', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  api.patch('/admin/subscription-vehicles/:subscriptionVehicleId', requireAuth(['ADMIN', 'OPS']), async (req: Request, res: Response, next: NextFunction) => {
    try {
