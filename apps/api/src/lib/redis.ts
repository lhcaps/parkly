...
// Named re-exports for named-import consumers (lane-lock.ts, idempotency.middleware.ts)
// Note: getRedisClient, buildRedisKey, runRedisCommand, pingRedis, getRedisHealth
// are already exported via their `export async function` declarations above.
