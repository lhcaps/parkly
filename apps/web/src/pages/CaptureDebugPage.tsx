  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="Capture"
        title="Capture Debug"
        description="Monitor OCR preview, capture feed, and mapping summary to identify ingest errors or camera mismatches."
        badges={[
          ...
          <Card className="h-full border-border/80 bg-card/95 transition hover:border-primary/30 hover:bg-primary/5">
            <CardContent className="flex h-full items-start gap-3 pt-5">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Create QR codes and pair links for mobile devices from desktop.</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="h-full border-border/80 bg-card/95 transition hover:border-primary/30 hover:bg-primary/5">
            <CardContent className="flex h-full items-start gap-3 pt-5">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Open the mobile surface to submit images, preview, and heartbeat.</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="h-full border-border/80 bg-card/95 transition hover:border-primary/30 hover:bg-primary/5">
            <CardContent className="flex h-full items-start gap-3 pt-5">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Switch to the main operations screen for decisions and barrier actions.</p>
              </div>
            </CardContent>
          </Card>
        </Link>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-3xl border border-border/80 bg-card/95 p-5 shadow-[0_18px_60px_rgba(0,0,0,0.12)]">
            ...
            {!summary ? (
              <div className="rounded-2xl border border-dashed border-border/80 bg-background/40 px-4 py-10 text-center text-sm text-muted-foreground">
                Select a row in the capture feed to view context mapping.
              </div>
            ) : (
          ...
          <div className="rounded-2xl border border-border/80 bg-card/95 p-4 text-sm text-muted-foreground">
            Capture Debug is for reading input signals and OCR preview only. Business decisions should be made in Run Lane or Review Queue.
          </div>
        </div>
      </div>
    </div>
