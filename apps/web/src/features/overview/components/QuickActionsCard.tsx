          ...
          {actions.map(({ to, label, helper, badge, icon: Icon }) => (
            <Link
              ...
              className={cn(
                ...
                'hover:border-primary/40 hover:bg-primary/8 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:-translate-y-1',
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 text-primary transition-all duration-300 group-hover:scale-110 group-hover:bg-primary/15 group-hover:border-primary/30">
              ...
              <div className="absolute inset-x-0 bottom-0 h-0.5 origin-left scale-x-0 rounded-b-2xl bg-gradient-to-r from-primary/60 via-primary/80 to-primary transition-transform duration-300 group-hover:scale-x-100" />
            </Link>
          ))}
        </div>
      </CardContent>
