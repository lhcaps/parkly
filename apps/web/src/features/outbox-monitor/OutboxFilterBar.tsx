...
export function OutboxFilterBar({
  ...
  return (
    <FilterCard
      ...
      description="Stable filters and search for tracing failed cases by correlation, request, or entity without losing state across refreshes."
      actions={
        <>
    ...
    >
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Input value={keyword} onChange={(event) => onKeywordChange(event.target.value)} placeholder="Outbox, plate, lane, or error..." aria-label="Search outbox records" disabled={loading} />
