  ...
  return (
    <Card className="border-border/80 bg-card/95">
      <CardHeader>
        ...
        <CardDescription>
          Session state, lane identity, and allowed actions are shown immediately — operators do not need to remember context after submit.ảy sang màn khác.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        {session ? (
          ...
          <div className="flex min-h-[180px] flex-col items-center justify-center rounded-3xl border border-dashed border-border/80 bg-background/40 px-6 py-8 text-center">
            <p className="text-sm font-medium">— session result</p>
            <p className="mt-1 text-xs text-muted-foreground">
              After a successful submit, this card shows the latest authoritative session.
            </p>
          </div>
        )}
      </CardContent>
