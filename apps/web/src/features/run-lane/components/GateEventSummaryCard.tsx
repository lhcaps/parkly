  ...
  return (
    <Card className="border-border/80 bg-card/95">
      <CardHeader>
        ...
        <CardDescription>
          After submit: event ID, outbox ID, which lane/device recorded, and whether health state changed.ay không.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        {event ? (
          ...
          <div className="flex min-h-[180px] flex-col items-center justify-center rounded-3xl border border-dashed border-border/80 bg-background/40 px-6 py-8 text-center">
            <p className="text-sm font-medium">— gate event result</p>
            <p className="mt-1 text-xs text-muted-foreground">
              Gate event summary will appear after a successful lane flow submission.
            </p>
          </div>
        )}
      </CardContent>
