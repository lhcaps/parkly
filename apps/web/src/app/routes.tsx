...
const pageLoaders = {
  ...
  topology: () => import('@/pages/TopologyPage').then((module) => ({ default: module.TopologyPage })),
  accounts: () => import('@/pages/AccountsPage').then((module) => ({ default: module.AccountsPage })),
} as const
...
const TopologyPage = lazy(pageLoaders.topology)
...
const ROUTE_VIEWS: RouteViewDefinition[] = [
  ...
  { path: '/topology', icon: Network, element: <TopologyPage /> },
  { path: '/accounts', icon: UserCog, element: <AccountsPage /> },
