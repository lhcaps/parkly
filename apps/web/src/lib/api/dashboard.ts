...
function normalizeSiteOverviewRow(value: unknown): DashboardSiteOverviewRow | null {
  ...
  return {
    ...
    zoneCount: toFiniteNumber(value.zoneCount),
    gateCount: toFiniteNumber(value.gateCount),
    laneCount: toFiniteNumber(value.laneCount),
    deviceCount: toFiniteNumber(value.deviceCount),
    zoneCodes: Array.isArray(value.zoneCodes) ? value.zoneCodes : [],
    zoneNames: Array.isArray(value.zoneNames) ? value.zoneNames : [],
    vehicleTypes: Array.isArray(value.vehicleTypes) ? value.vehicleTypes : [],
  }
}
