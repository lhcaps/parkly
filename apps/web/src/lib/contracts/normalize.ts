...
import type { SessionAllowedAction, SessionState, SessionSummary } from '@/lib/contracts/sessions'
...
function sessionStateOrDefault(value: unknown): SessionState {
...
function directionOrDefault(value: unknown): 'ENTRY' | 'EXIT' {
