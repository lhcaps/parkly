...
- screenshots/landing-super-admin.png
- screenshots/landing-site-admin.png
- screenshots/landing-manager.png
- screenshots/landing-operator.png
- screenshots/landing-guard.png
- screenshots/landing-cashier.png
- screenshots/landing-viewer.png
- screenshots/forbidden-fallback.png
- screenshots/review-queue-action-desk.png
- screenshots/session-history-detail-error.png
- screenshots/outbox-triage.png
- screenshots/subscriptions-deeplink.png
- screenshots/parking-live-stale-fallback.png
- screenshots/mobile-pair-qr.png
- screenshots/mobile-capture-receipt.png
- screenshots/settings-theme-dark.png
- screenshots/topology-dialogs.png
